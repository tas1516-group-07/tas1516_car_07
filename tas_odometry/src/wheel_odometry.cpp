...
{
	int base_link_index = std::distance(link_states->name.begin(), std::find (link_states->name.begin(), link_states->name.end(), "ackermann_vehicle::base_link"));
	...
	//Diese werte sollten aus der Geschwindigkeit berechnet werden
...
int main(int argc, char** argv){
  ...
  //hier anstatt die link states die entsprechende message mit geschwindigkeiten subscriben
